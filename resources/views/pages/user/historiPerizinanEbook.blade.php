        ...
        <div class="flex justify-center lg:mb-6 mb-2">
            <div class="flex justify-between items-center border banner" style="border-color: black;">
                <div class="banner-status bg-indigo-500 text-white px-3 py-2">
                    <p class="text-center text-xl">SIAP DOWNLOAD EBOOK</p>
                </div>
                <div class="banner-informasi bg-white  px-3 py-2">
                    <p class="text-center text-xl ">SILAHKAN DOWNLOAD EBOOK YANG KAMU MAU!</p>
                </div>
            </div>
        </div>
        <div class="container-detailBukus h-full w-full">
            <div class="image">
                <img src="{{ asset('storage/' . $siapdownload->buku->gambar) }}" class="w-100" alt="Buku Gambar">
            </div>
            <div class="text">
                <h3>{{ $siapdownload->buku->nama }}</h3>
                <hr class="h-px rounded mt-4 bg-gray-400 border-0 dark:bg-gray-700">
                <p><span>Pengarang:</span> {{ $siapdownload->buku->pengarang }}</p>
                <p><span>Penerbit:</span> {{ $siapdownload->buku->penerbit }}</p>
                <p><span>Halaman:</span> {{ $siapdownload->buku->halaman }}</p>
                <p><span>Tahun Terbit:</span> {{ $siapdownload->buku->tahun_terbit }}</p>
                <p><span>Kategori:</span> {{ $siapdownload->buku->kategori }}</p>
                <p><span>Genre:</span> {{ $siapdownload->buku->genre }}</p>
            </div>
        </div>
    </div>
    @else
        <div class="flex flex-col justify-center items-center" style="margin: 100px 0px;">
            ...
            <h3>TIDAK ADA DATA PERIZINAN EBOOK</h3>
        </div>
    @endif
